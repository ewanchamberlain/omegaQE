...
if __name__ == "__main__":
    ...
    if len(args) != 9:
        raise ValueError(
            "Must supply arguments: exp fields gmv resp_ps Nell T_Lmin T_Lmax P_Lmin P_Lmax"
        )
    exp = str(args[0])
    fields = str(args[1])
